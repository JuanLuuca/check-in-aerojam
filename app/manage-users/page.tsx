...
import React, { useEffect, useState } from 'react';
import { Container, Typography, Button, Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Select, MenuItem, InputLabel, FormControl, useMediaQuery, useTheme, SelectChangeEvent, TablePagination } from '@mui/material';
import Swal from 'sweetalert2';
import withReactContent from 'sweetalert2-react-content';
import SideBar from '../components/sidebar/Sidebar';
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell style={{ color: 'white' }}>Perfil</TableCell>
                      <TableCell style={{ color: 'white' }}>Aulas</TableCell>
                      <TableCell style={{ color: 'white' }}>Ações</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>

...
export function ModalCreateUser({ open, onClose, onSubmit, loading, user, onInputChange, onPerfilChange }: ModalCreateUserProps) {
  if (!open) return null;
        ...
        <div className="inline-block align-bottom bg-zinc-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
          <div className="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="login" className="block text-sm font-medium text-zinc-300">
                  Login
                </label>
                <input
                  type="text"
                  ...
                  className="mt-1 block w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded-md text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              ...
              <div>
                <label htmlFor="perfil" className="block text-sm font-medium text-zinc-300">
                  Perfil
                </label>
                <select
                  id="perfil"
                  ...
                  className="mt-1 block w-full px-3 py-2 bg-zinc-700 border border-zinc-600 rounded-md text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                >
              ...
              <div>
                <label htmlFor="qtdAulas" className="block text-sm font-medium text-zinc-300">
                  Aulas
                </label>
                <input
                  type="number"
